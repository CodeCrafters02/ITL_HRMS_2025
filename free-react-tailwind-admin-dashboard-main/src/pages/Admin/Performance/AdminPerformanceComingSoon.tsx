...
const AdminPerformanceComingSoon = ({ title, desc, plannedFeatures }: ComingSoonProps) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] py-8 animate__animated animate__fadeIn">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500 uppercase tracking-widest font-bold mb-4">Admin Console</p>
...
export default AdminPerformanceComingSoon;
