...
const DigitalMarketing = () => {
    ...
    const fetchSubServices = async () => {
      ...
      try {
        ...
        const filtered = allSubServices.filter(
          (sub) => sub.service_details?.name === "Digital Marketing"
        );
  ...
  return (
    <BaseLayout pageTitle="Our Digital Marketing Services" breadcrumbItems={breadcrumbItems}>
      ...
      <section>
        <div className="container mil-p-120-90">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h2 className="mil-center mil-up mil-mb-30">
                Explore Our <span className="mil-thin">Digital Marketing</span> Services
              </h2>
              <p className="mil-center mil-up mil-light-soft mil-mb-60">
                Innovative marketing solutions to amplify your brand and drive measurable results.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            {loading ? (
              <div>Loading digital marketing services...</div>
            ) : error ? (
              <div className="text-danger">{error}</div>
            ) : subServices.length === 0 ? (
              <div>No digital marketing services found.</div>
            ) : (
          ...
          <div className="container mil-p-120-90">
            <div className="row justify-content-between align-items-center">
              <div className="col-lg-7">
                <h2 className="mil-muted mil-up mil-mb-30">Want to Boost Your Brand Online?</h2>
                <p className="mil-light-soft mil-up mil-mb-40">
                  From SEO to social media, we craft custom digital strategies that deliver real results.
                </p>
                <div className="mil-up">
                  <Link to="/contact" className="mil-button mil-arrow-place">
                    <span>Request a Marketing Plan</span>
                  </Link>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="mil-up">
                  <img src="/src/Website/static/img/photo/digitalmarketing.jpg" alt="Digital Marketing" />
                </div>
              </div>
            </div>
          </div>
