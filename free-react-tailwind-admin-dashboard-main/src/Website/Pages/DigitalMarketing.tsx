                ...
                <div className="mil-inner-banner">
                    ...
                    {/* <div className="mil-banner-content mil-up">
                        <div className="container">
                            ...
                            <h1 className="mil-mb-60">Explore <span className="mil-thin">Our</span><br></br>Digital Marketing<span className="mil-thin"> Services</span></h1>
                        </div>
                    </div> */}
                </div>
                <section id="service">
                        ...
                        <div className="row justify-content-between">
                            <div className="col-lg-4 mil-relative mil-mb-90">
                                <h4 className="mil-up mil-mb-30">
                                  Our <span className="mil-thin">Approach</span> <br /> to <span className="mil-thin">Digital Marketing</span>
                                </h4>
                                <p className="mil-up mil-mb-30" style={{ color: 'black' }}>
                                  At our agency, we take a results-driven approach to digital marketing. We focus on creating strategies that not only enhance your online presence but also deliver measurable growth through SEO, social media, paid ads, and engaging content.
                                </p>
