...
const AnalyticsSolution = () => {
  ...
  useEffect(() => {
    const fetchSubServices = async () => {
      ...
      try {
        ...
        // Filter subservices where parent service name is "Analytics Solution"
        const filtered = allSubServices.filter(
          (sub) => sub.service_details?.name === "Analytics Solution"
        );
        setSubServices(filtered);
      } catch {
        setError("Failed to load analytics services.");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <BaseLayout pageTitle="Our Analytics Solutions" breadcrumbItems={breadcrumbItems}>
      ...
      <section>
        <div className="container mil-p-120-90">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h2 className="mil-center mil-up mil-mb-30">
                Explore Our <span className="mil-thin">Analytics Solutions</span>
              </h2>
              <p className="mil-center mil-up mil-light-soft mil-mb-60">
                Cutting-edge analytics services to unlock the full potential of your data.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            {loading ? (
              <div>Loading analytics services...</div>
            ) : error ? (
              <div className="text-danger">{error}</div>
            ) : subServices.length === 0 ? (
              <div>No analytics services found.</div>
            ) : (
          ...
          <div className="container mil-p-120-90">
            <div className="row justify-content-between align-items-center">
              <div className="col-lg-7">
                <h2 className="mil-muted mil-up mil-mb-30">Have a Data Challenge You Want to Solve?</h2>
                <p className="mil-light-soft mil-up mil-mb-40">
                  From data strategy to implementation, we deliver tailored analytics solutions for your business success.
                </p>
              ...
              <div className="col-lg-4">
                <div className="mil-up">
                  <img
                    src="/src/Website/static/img/photo/analytics.jpg"
