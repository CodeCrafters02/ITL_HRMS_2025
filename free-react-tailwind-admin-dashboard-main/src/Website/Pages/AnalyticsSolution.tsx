    ...
    useEffect(() => {
      const fetchSubServices = async () => {
        ...
        try {
          ...
          setError("Failed to load Analytics Solution services.");
        } finally {
          setLoading(false);
        }
      };
                    ...
                    {/* <div className="mil-banner-content mil-up">
                        <div className="container">
                            <ul className="mil-breadcrumbs mil-mb-60">
                                ...
                                <li><a href="/">Analytics Solution</a></li>
                            </ul>
                            <h1 className="mil-mb-60">Explore <span className="mil-thin">Our</span><br></br>Analytics Solutions<span className="mil-thin"> Services</span></h1>
                        </div>
                    </div> */}
                </div>
                <section id="service">
                        ...
                        <div className="row justify-content-between">
                            <div className="col-lg-4 mil-relative mil-mb-90">
                                <h4 className="mil-up mil-mb-30">
                                  Our <span className="mil-thin">Approach</span> <br /> to <span className="mil-thin">Analytics Solutions</span>
                                </h4>
                                <p className="mil-up mil-mb-30">
                                  At our company, we take a data-driven approach to analytics solutions. We focus on transforming raw data into actionable insights that empower smarter decisions, optimize performance, and uncover new opportunities—leveraging advanced analytics, AI, and modern visualization tools.
                                </p>
