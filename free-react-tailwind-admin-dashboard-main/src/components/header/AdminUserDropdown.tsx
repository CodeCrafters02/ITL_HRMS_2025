      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          {companyLogo ? (
            ...
            <div className="bg-gray-200 h-11 w-11 rounded-full" />
          )}
        </span>
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <li className="relative group">
            ...
            >
              ...
              Account settings
              <svg className="ml-auto w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg>
            </button>
            <ul className="absolute left-0 top-full z-10 hidden group-hover:block bg-white dark:bg-gray-dark border border-gray-200 dark:border-gray-800 rounded-lg shadow-lg min-w-[160px]">
              <li>
                <DropdownItem
