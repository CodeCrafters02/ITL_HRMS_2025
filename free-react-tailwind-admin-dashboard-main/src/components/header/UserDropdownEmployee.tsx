...
export default function UserDropdownEmployee() {
          ...
          <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
            <li className="relative">
              <div className="w-full">
                <button
                  type="button"
                  className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg text-theme-sm dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5 w-full"
              ...
              Account settings
              <svg
                className={`ml-auto transition-transform duration-200 ${isAccountSettingsOpen ? "rotate-180" : ""}`}
                width="18"
                height="18"
                viewBox="0 0 18 18"
                fill="none"
              ...
              >
                ...
                {isAccountSettingsOpen && (
                  <ul className="ml-8 mt-1 flex flex-col gap-1 bg-white dark:bg-gray-900 rounded shadow-lg absolute left-0 z-10 w-48 border border-gray-200 dark:border-gray-800">
                    <li>
                      <DropdownItem
