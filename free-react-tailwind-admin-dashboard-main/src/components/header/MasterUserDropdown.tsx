...
export default function MasterUserDropdown() {
  const [masterInfo, setMasterInfo] = useState({ username: "", email: "" });
  ...
  useEffect(() => {
    ...
    .then(res => {
      console.log("master-register response:", res.data);
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">{masterInfo.username}</span>
        <svg
