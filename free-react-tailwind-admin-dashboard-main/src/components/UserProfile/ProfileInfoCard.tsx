      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Employee ID</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{profile.employee_id}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{profile.middle_name || '-'}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{profile.gender}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{profile.date_of_birth}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{profile.department_name || profile.department || '-'}</p>
            </div>
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Designation</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{profile.designation_name || profile.designation || '-'}</p>
            </div>
            
          </div>
        </div>
        <div className="flex items-start justify-end mt-4 lg:mt-0">
          <button
