# Generated by Django 5.1.6 on 2026-04-15 07:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('break_choice', models.CharField(blank=True, choices=[('dont_disturb', "Don't Disturb"), ('short_break', 'Short Break'), ('meal_break', 'Meal Break')], max_length=20, null=True)),
                ('duration_minutes', models.PositiveIntegerField(blank=True, null=True)),
                ('enabled', models.BooleanField(default=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='break_configs', to='app.company')),
            ],
        ),
        migrations.CreateModel(
            name='AssetInventory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_userregister', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aadhar_card', models.FileField(blank=True, null=True, upload_to='employee/aadhar')),
                ('pan_no', models.CharField(blank=True, max_length=100, null=True)),
                ('pan_card', models.FileField(blank=True, null=True, upload_to='employee/pancard')),
                ('guardian_name', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('who_referred', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('break_config', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.breakconfig')),
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='break_logs', to='app.employee')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.TextField(blank=True, null=True)),
                ('employee', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='relieved_info', to='app.employee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, choices=[('offer', 'Offer'), ('appointment', 'Appointment'), ('relieve', 'Relieve')], max_length=20, null=True)),
                ...
                ('relieved_employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.relievedemployee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conveyance_percent', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('medical_percent', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('special_percent', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('service_charge_percent', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.company')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.department')),
                ('shifts', models.ManyToManyField(blank=True, to='app.shiftpolicy')),
            ],
            options={
