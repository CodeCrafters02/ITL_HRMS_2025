            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6 gap-4">
                ...
                >
                    <div className="flex items-start justify-between gap-2">
                        ...
                        <IconListCheck className="w-5 h-5 text-primary shrink-0 opacity-80 group-hover:opacity-100" />
                    </div>
                    {latestLeave ? (
                        <>
                            ...
                            <p className="text-[10px] text-white-dark/80 mt-1">Latest by request date — open for full history</p>
                        </>
                    ) : (
                        <>
